...
<tr><td>2. Contradicting your own docs</td><td><span class="bp-yes">✓ Mostly</span></td><td>A sentence that names real components and says where they live or what they depend on can be turned into a query and run at both revisions. A sentence about intent, taste or process cannot, and should be reported as unanswerable rather than guessed at.</td></tr>
