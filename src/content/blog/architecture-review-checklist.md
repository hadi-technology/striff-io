...
<p class="bp-figure-caption">Every red flag in this table corresponds to a real finding from <a href="/blog/architectural-findings-in-oss">our 12-repo OSS scan</a> — boundary inversions in Pinot, a cycle in GraalVM, near-cycles in HikariCP, a 24-dependent contract change reviewed as trivial.</p>
</div>
